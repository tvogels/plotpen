...
def main():
    ...
    layout = pp.layout(padding=30)(
        ...
        pp.div(id="hist", data="Histogram", margin=20, flex_grow=1, width=300, height=230),
    )
        ...
        svg.g(font_family="Helvetica", stroke_linecap="round")(
            svg.g(
                ...
                pp.clip([
                    ...
                    pp.scatter(xscale(x), yscale(y), box, marker=",", marker_size=6, marker_thickness=1.5, fill="solid"),
                    pp.plot(
                        xscale(x),
                        yscale(y2),
                        box,
